...
mod tests {
    use super::registry::{
        install_method_from, npm_executable, parse_cargo_version, parse_npm_version,
        registry_version, run_registry_command,
    };
    #[cfg(unix)]
    use super::start_background_check;
    use super::{
        InstallMethod, StableVersion, UpdateCache, automatic_allowed, load_cache, notice,
