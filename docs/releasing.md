# Typerlude release handoff / 배포 인수인계

이 문서는 공개 저장소 `baba9811/typerlude`의 소스 공개와 일반 CI가 완료된 뒤, 최초
...
Relevant settings: [rulesets](https://github.com/baba9811/typerlude/settings/rules),
[environments](https://github.com/baba9811/typerlude/settings/environments), and
[Actions](https://github.com/baba9811/typerlude/settings/actions).
...
Open the [Release workflow](https://github.com/baba9811/typerlude/actions/workflows/release.yml),
...
crates.io cannot configure trusted publishing until the crate exists. After `typerlude 1.0.0` is
visible, open `typerlude → Settings → Trusted Publishing → Add` and enter exactly:

- Publisher: GitHub
- Repository owner: `baba9811`
- Repository name: `typerlude`
